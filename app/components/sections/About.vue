      ...
      <div class="grid md:grid-cols-2 gap-10 lg:gap-16">
        ...
        <div class="grid grid-cols-2 gap-3">
          <div
            ...
            :key="tech"
            class="group flex items-center gap-3 px-4 py-3.5 bg-card border rounded-xl transition-all duration-200 hover:border-primary/40 hover:shadow-sm hover:-translate-y-0.5"
          >
            <span class="w-2 h-2 rounded-full bg-primary group-hover:scale-125 transition-transform" />
            <span class="font-mono text-sm text-muted-foreground group-hover:text-foreground transition-colors">{{ tech }}</span>
          </div>
        </div>
      </div>
    </div>
